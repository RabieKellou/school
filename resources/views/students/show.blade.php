        ...
        <form method="post" action="{{ route('students.update',$user->user_id) }}">
            ...
            <div class="form-group">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6"><input type="text" name="SECTION" class="form-control" value=""></div>
                    <div class="clearfix"></div>
                </div>
                <div class="row">
                    <label class="col-md-3">Departement</label>
                    <div class="col-md-6"><input type="text" name="FILIERE" class="form-control" value="{{$user->student->option->opt_name}}"></div>
                    <div class="clearfix"></div>
                </div>
                <div class="row">
